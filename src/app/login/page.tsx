      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[oklch(0.28_0.07_155)] to-[oklch(0.40_0.12_155)] items-center justify-center p-12">
        <div className="max-w-md text-white space-y-8">
          ...
          <p className="text-white/70 text-lg leading-relaxed">
            AI-powered cross-platform listing tool for Depop, Grailed, Poshmark, and Mercari. Optimize your listings, track analytics, and grow your reselling business.
          </p>
          <div className="flex gap-3 pt-4">
            {["Depop", "Grailed", "Poshmark", "Mercari"].map((p) => (
              <span
                key={p}
